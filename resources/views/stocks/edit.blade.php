            ...
            <div id="Form-advance" class="card card card-default scrollspy">
                <div class="card-content">
                    ...
                    <form action="{{ route('stocks.update',$stock->id) }}" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="row">
                             ...
                             <div class="input-field col s12">
                              ...
                              <div class="input-field col s12">
                                ...
                                <input type="number" name="quantity" id="quantity" value="{{$stock->quantity}}" class="validate" required
                                    min="0" step="0.01">
                                @error('quantity')
                                    <span class="helper-text" data-error="wrong"
                                        data-success="right">{{ $message }}</span>
                        ...
                        <button type="submit" class="btn waves-effect waves-light">Update Stock</button>
                    </form>
