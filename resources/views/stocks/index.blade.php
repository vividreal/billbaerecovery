...
@section('page-action')
    <a href="{{ route('stocks.create') }}" class="btn waves-effect waves-light cyan breadcrumbs-btn right"
        ...
        <div class="col s12 m12 l12">
            <div id="button-trigger" class="card card card-default scrollspy">
                <div class="card-content">
                    ...
                    <div class="row">
                        <div class="col s12">
                            <table id="data-table-stocks" class="display data-tables">
                                <thead>
                                    <tr>
                                        <th>No</th>                                       
                                        <th>Product Code</th>
    ...
    $(function() {
        $('#data-table-stocks').DataTable({
            ...
            columns: [
                ...
                { data: 'name', name: 'name' },
                { data: 'category_name', name: 'category_name' }, // Access category name
