      ...
      <div class="col s12 m12 l12">
          <div id="button-trigger" class="card card card-default scrollspy">
            <div class="card-content">
                ...
                <div class="row">
                  <div class="col s12">
                    <table id="data-table-users" class="display data-tables" data-url="{{ $page->link }}" data-form="dt-filter-form" data-length="10">
                      <thead>
                        <tr>
                          ...
                          <th width="100px" data-orderable="false" data-column="role"> Roles </th>
                          <th width="100px" data-orderable="false" data-column="activate"> Status </th>
