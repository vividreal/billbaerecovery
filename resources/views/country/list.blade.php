      ...
      <div class="container-fluid">
        <div class="row mb-2">
          ...
          <div class="col-sm-6">
            ...
            <button class="btn btn-success ajax-submit" onclick="manageCountry(null)">Add {{ $page->title ?? ''}}</button>
...
<script>
  ...
  function manageCountry(country_id){
    validator.resetForm();
    ...
    if (country_id === null) {
        ...
        $.ajax({url: "{{ url(ROUTE_PREFIX.'/'.$page->route) }}/" + country_id + "/edit", type: "GET", dataType: "html"})
            .done(function (a) {
  ...
  if ($("#{{$page->entity}}Form").length > 0) {
    var validator = $("#{{$page->entity}}Form").validate({ 
        ...
        submitHandler: function (form) {
          ...
          $.ajax({ url: "{{ url(ROUTE_PREFIX.'/'.$page->route) }}" + country_id, type: formMethod, processData: false, 
